<script>
export default {
  name: 'gekon-section-double-card',
  data () {
    return {
      selectedTab: 'detail'
    }
        ...
        q-tab-panels(:value="selectedTab" animated).no-alt-scroll
          ...
          q-tab-panel(name="kalkulace")
            div
              slot(name="second")
      .page-section-tabs
        q-tabs(v-model="selectedTab" align="justify" dense no-caps indicator-color="green" )
...
<style scoped lang="stylus">
  ...
  $gekonCardHeight ?= $cardWidth
  $contentHeight = $gekonCardHeight - $iconContainerSize - $gekonTitleContainerSize - $gekonTabsContainerSize
