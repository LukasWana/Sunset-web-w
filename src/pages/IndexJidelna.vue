...
import JidelnaGallery from 'src/jidelnasql.cz/components/JidelnaGallery'
import JidelnaSectionDoubleCard from 'src/jidelnasql.cz/components/JidelnaSectionDoubleCard'
