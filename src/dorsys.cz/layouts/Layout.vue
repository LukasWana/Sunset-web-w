<template lang="pug">
  q-layout(view="lHh Lpr lFf" class="is-dorsys")
    q-header(elevated reveal v-model="headerOpen").layout-header
      q-toolbar.page-fixed-width
        img(src="~assets/logo-dorsys.svg" alt="Logo Dorsys" width="100")
        q-toolbar-title
          // lang-switcher-flags
          // router-link(:to="{path: '/gekon'}") gekon
    q-page-container.bg-img
